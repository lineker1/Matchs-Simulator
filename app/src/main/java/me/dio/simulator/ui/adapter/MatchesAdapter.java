...
public class MatchesAdapter extends RecyclerView.Adapter<MatchesAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        Glide.with(context).load(match.getVisitantTeam().getImage()).circleCrop().into(holder.binding.imgVisitantTeam);
        holder.binding.nameVisitantTeam.setText(match.getVisitantTeam().getName());
        if (match.getVisitantTeam().getScore() != null) {
